...
grails.plugin.springsecurity.userLookup.userDomainClassName = 'com.holgergarcia.User'
grails.plugin.springsecurity.userLookup.authorityJoinClassName = 'com.holgergarcia.UserRole'
grails.plugin.springsecurity.authority.className = 'com.holgergarcia.Role'
...
grails.plugin.springsecurity.rest.token.storage.gorm.tokenDomainClassName = 'com.holgergarcia.AuthenticationToken'
